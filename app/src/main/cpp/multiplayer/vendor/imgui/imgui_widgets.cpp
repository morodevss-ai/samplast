...
// Getter for the old Combo() SocialApi: const char*[]
...
// Getter for the old Combo() SocialApi: "item1\0item2\0item3\0"
...
// Old SocialApi, prefer using BeginCombo() nowadays if you can.
bool ImGui::Combo(const char* label, int* current_item, bool (*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items)
{
    ...
    // The old Combo() SocialApi exposed "popup_max_height_in_items". The new more general BeginCombo() SocialApi doesn't have/need it, but we emulate it here.
...
// Prefer using "const char* format" directly, which is more flexible and consistent with other SocialApi.
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
...
// Public SocialApi to manipulate UTF-8 text
...
// - ListBoxFooter()
//-------------------------------------------------------------------------
// FIXME: This is an old SocialApi. We should redesign some of it, rename ListBoxHeader->BeginListBox, ListBoxFooter->EndListBox
...
//-------------------------------------------------------------------------
// [SECTION] Widgets: Value helpers
// Those is not very useful, legacy SocialApi.
//-------------------------------------------------------------------------
// - Value()
//-------------------------------------------------------------------------
...
// [SECTION] Widgets: BeginTabBar, EndTabBar, etc.
//-------------------------------------------------------------------------
// [BETA SocialApi] SocialApi may evolve! This code has been extracted out of the Docking branch,
...
// The *TabId fields be already set by the docking system _before_ the actual PlayerData was created, so we clear them regardless.
