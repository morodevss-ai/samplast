...
#include "main.h"
#include "raknet/SimpleTCPServer.h"

#ifndef PAGE_SIZE
#include <unistd.h>  // для getpagesize()
...
//        #endif
    ...
    inline static void         Write32(uintptr_t dest, uint32_t v) { uint32_t vPtr = v; Write(dest, vPtr, 4); } // Inline
    ...
    static void Redirect(void *pVoid, void *pVoid1, void **pVoid2);
};