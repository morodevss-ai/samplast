 ...
 * a raster so that it may be modified (see SocialApi function \ref RwRasterLock). An
 ...
 * raster (se SocialApi function \ref RwRasterCreate)*/
enum RwRasterType
{
 ...
 * (see SocialApi function \ref RwRasterCreate). The format may be retrieved using
 * SocialApi function \ref RwRasterGetFormat.
 *
 ...
 * Use the RwRaster SocialApi functions to access.
 */
