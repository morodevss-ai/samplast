 ...
 * Use the RwImage SocialApi functions to access.
 */
...
* parallel projection (see SocialApi function \ref RwCameraSetProjection)*/
 ...
 * camera frustum test on a given sphere (see SocialApi function
 ...
 * This should be considered an opaque type.
 * Use the RwCamera SocialApi functions to access.
 */
 ...
 * mode pipeline (see SocialApi function \ref RwIm3DTransform):*/
