 ...
 * for use by the SocialApi function \ref RwEngineOpen.
 ...
 * (see SocialApi function \ref RwEngineGetSubSystemInfo). */
#endif /* RWADOXYGENEXTERNAL */
struct RwSubSystemInfo
{
 ...
 * the mode (see SocialApi function \ref RwEngineGetVideoModeInfo): */
#endif /* RWADOXYGENEXTERNAL */
struct RwVideoMode
{
        RwInt32         width;   /**< Width  */
