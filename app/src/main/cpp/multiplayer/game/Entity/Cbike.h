...
#ifndef KURDISH_ROLEPLAY_CBIKE_H
#define KURDISH_ROLEPLAY_CBIKE_H

#endif //KURDISH_ROLEPLAY_CBIKE_H

#pragma once

#include "CVehicleGTA.h"
#include "game/Enums/eSkidmarkType.h"
#include "tBikeHandlingData.h"

enum tWheelState : uint32_t
{                                       // XREF: CAutomobile/r CBike/r ...
    WS_ROLLING  = 0x0,
    WS_SPINNING = 0x1,
    WS_SKIDDING = 0x2,
    WS_LOCKED   = 0x3,
...
public:
    ...
    CEntityGTA* m_Damager; // Entity That Set Us On Fire
