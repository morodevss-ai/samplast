...
public:
    ...
    RwTexture* Generate(const char* text, int size, int font_size, bool bold, const char* fontname, uint32_t font_color, uint32_t background_color, int alignment);

private:
	void SetUpScene();
	void Render(const char* text, const ImVec2& size, int font_size, bool bold, const char* fontname,
